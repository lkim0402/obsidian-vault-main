...
>[!Express.js]
>A JavaScript framework that allows us to create [[Backend Engineering]] for our websites.
...
- [[🖥️backend/tools/Next.js]] VS node.js + express.js
...
- what we'll use
	- [[Backend & Main Components Explained#Server|server]] - our local computer
...
- A special address that points to your **own computer**.
	- basically making our own computer the server of our website's [[Backend & Main Components Explained|backend]]
