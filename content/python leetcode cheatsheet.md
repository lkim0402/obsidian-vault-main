...
- (literally crapped this from neetcode - https://neetcode.io/courses/lessons/python-for-coding-interviews)
# Variables
```python
...
- more about dict comprehension!!! (super useful!!)
```python
# dict
names = ["jane", "jack", "aaaa", "hi"]
myMap = {i : (i.count('a')) for i in names}
print(myMap)
```
## Tuples
