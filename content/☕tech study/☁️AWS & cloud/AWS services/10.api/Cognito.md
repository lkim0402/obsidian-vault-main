...
- similar to [[IAM & Identities|IAM service]] where you create users that can access this AWS account.... but not related to our service!
...
- Create user pools
	...
	- Assigns temporary [[IAM & Identities|IAM]] permissions to users (ex. so that users can upload a file to a [[S3 (Simple Storage Service)|S3]] bucket if that's what ur app is doing)
