...
-  Define the stages (Configuration)
	...
	- You can add other stages which are not based on these code services (ex. manual approval stage, or [[☕tech study/☁️AWS & cloud/AWS services/4.compute/Lambda]] that execute some scripts)
- Execute pipeline
