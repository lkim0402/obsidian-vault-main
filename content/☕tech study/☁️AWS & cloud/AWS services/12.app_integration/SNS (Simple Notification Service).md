...
- messages are pushed directly to applications registered as **subscribers** 
	...
	- Subscribers can be: [[☕tech study/☁️AWS & cloud/AWS services/4.compute/Lambda|lambda functions]], [[SQS (Simple Queue Service)|SQS queues]], HTTP/HTTPS endpoints, emails, mobile push, etc
- **synchronous**
