...
## Motivation
- Possible
	- One setup - 1 account with multiple [[IAM & Identities|IAM users]]
- Can be better
	...
	2.  Use free tier / monthly free usage multiple times (ex. monthly free [[☕tech study/☁️AWS & cloud/AWS services/4.compute/Lambda]] executions)
