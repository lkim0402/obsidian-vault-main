...
- Static website hosting
	- You can put website files in there if it doesn't have [[Backend & Main Components Explained#Server|server-side]] code
...
# Bucket policies
- Bucket policies are [[IAM & Identities#Policies & Permissions|IAM policies]] that define permissions, but NOT attached to users or roles, but to buckets
