...
- Migrate step-by-step
	- migrate individual [[Backend & Main Components Explained#Server|servers]] or basic workloads, then continue step by step
...
- Helps with migrating data from a local db to an [[Databases (AWS)|AWS database]]
	- [[🗃️Database]]
