...
- A runtime environment
	...
	- Node allows us to use JS outside browsers, maintaining our full JS stack from [[Frontend|frontend]] to [[Backend Engineering|backend]]
- asynchronous, event-driven
	- js code doesn't have to do everything sequentially
- In summary, we need node because it allows us to build an [[Backend & Main Components Explained#Application|application]] on a computer using JS
	- this application will be running on our [[Backend & Main Components Explained#Server|server (a computer, which is NOT a browser)]], and Node.js allows that to happen
