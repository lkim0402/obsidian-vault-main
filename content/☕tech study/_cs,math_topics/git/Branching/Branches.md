...
- `git init`
	- you're making a `main` branch by default
...
- `main`
	...
	- More and more people are using `main` more now
## HEAD -> master
![[Pasted image 20240918174235.png]]
`HEAD`
- A pointer that points to the branch **currently active** in my [[Git workflow (add and commit)#Git repository|git repo]]. 
...
- Added a file & committed on the new branch `DarkMode`. It diverges when you actually make a change and commit.
