...
product = "cake"
chain.run(product) # "Sweet Delights Bakery"
```
# Sequential Chains
...
- chain 1: translate non-eng review to english
```python
...
- diagram
	![[Pasted image 20260217171626.png]]
...
```
- `default_chain`
	- the chain used when the router can't decide which chain to use
...
```
- `router_template`
	- we create this by using the destinations above